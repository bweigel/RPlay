...
```{r}
knitr::opts_chunk$set(echo=F, error=T,warning=F, message=F, fig.width=12, fig.heíght=12,
                      cache.path = 'cache_files/', fig.path='figure/')
```
...
dsn <- "/home/bweigel/Data/GIS/PLZ/3stellig/plz-3stellig.shp"
...
dsn <- "/home/bweigel/Data/GIS/NUTS 2013/data/NUTS_RG_10M_2013.shp"
layer <- ogrListLayers(dsn)[1]
...
# works well enough, but the problem is, 
# that the points taken from different polygons aren't in order
id <- 4
ggplot() +
...
N=10000
# simulate points over the whole area (use uniform distribution)
